 ...
 * Script: aitype\enemy_pdf_nicaragua_sniper_base.gsc
*******************************************************/

#include codescripts\character;
#include character\c_pan_pdf_heavy_char;
#include character\c_pan_pdf_medium_char;
#include character\c_pan_pdf_light_char;
