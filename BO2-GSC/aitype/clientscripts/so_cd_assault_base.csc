 ...
 * Script: aitype\clientscripts\so_cd_assault_base.csc
*********************************************************/

#include character\clientscripts\c_mul_cordis1_1;
...
main() {
  switch (self getcharacterindex()) {
    case 0:
      character\clientscripts\c_mul_cordis1_1::main();
      break;
    case 1:
  ...
  self._aitype = "So_cd_Assault_Base";
}

precache(ai_index) {
  character\clientscripts\c_mul_cordis1_1::precache();
