...
main() {
  switch (self getcharacterindex()) {
    case 0:
      character\clientscripts\c_zom_zombie_buried_miner3::main();
      break;
    case 1:
      character\clientscripts\c_zom_zombie_buried_miner3_nohat::main();
      break;
    case 2:
      character\clientscripts\c_zom_zombie_buried_miner3_nohat::main();
      break;
  ...
  self._aitype = "zm_buried_basic_02_char_03";
}

#using_animtree("zm_buried_basic");

precache(ai_index) {
  character\clientscripts\c_zom_zombie_buried_miner3::precache();
  character\clientscripts\c_zom_zombie_buried_miner3_nohat::precache();
  character\clientscripts\c_zom_zombie_buried_miner3_nohat::precache();
